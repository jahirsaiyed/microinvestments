...
describe('Promotions Management Component', () => {
  let comp: PromotionsComponent;
  let fixture: ComponentFixture<PromotionsComponent>;
  let service: PromotionsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'promotions', component: PromotionsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PromotionsComponent, '')
      .compileComponents();

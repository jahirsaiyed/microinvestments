...
describe('Investor Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'investor', component: InvestorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.investors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

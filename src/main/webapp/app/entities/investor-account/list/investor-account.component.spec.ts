...
describe('InvestorAccount Management Component', () => {
  let comp: InvestorAccountComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'investor-account', component: InvestorAccountComponent }]),
      ...
      .overrideTemplate(InvestorAccountComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.investorAccounts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

...
describe('InvestorPortfolio Management Component', () => {
  let comp: InvestorPortfolioComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'investor-portfolio', component: InvestorPortfolioComponent }]),
      ...
      .overrideTemplate(InvestorPortfolioComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.investorPortfolios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

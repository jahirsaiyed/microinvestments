...
/**
 * A DTO for the {@link com.finance.investment.micro.domain.AssetDetailsAudit} entity.
 */
public class AssetDetailsAuditDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssetDetailsAuditDTO)) {
            return false;
        }

        AssetDetailsAuditDTO assetDetailsAuditDTO = (AssetDetailsAuditDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, assetDetailsAuditDTO.id);
    }
